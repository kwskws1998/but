...
sys.path.append(path)
from reward_utils.dataset_proceser_reward import DatasetProceserReward
...
class RewardTrainerConstructor:
    ...
    def load_dataset(
        ...
        max_length, max_tokens = resolve_input_limits(max_length, max_tokens)
        # dataset_name = 'OpenAssistant/oasst1'
